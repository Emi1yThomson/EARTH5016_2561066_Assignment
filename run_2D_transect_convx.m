...
title('Numerical Convergence in Space [x dimension]','FontSize',20, 'FontName','Times New Roman')
...
xlabel('Step size','FontSize',18, 'FontName','Times New Roman')
ylabel('Numerical error','FontSize',18, 'FontName','Times New Roman')
title('Numerical Convergence in Space [z dimension]','FontSize',20, 'FontName','Times New Roman')